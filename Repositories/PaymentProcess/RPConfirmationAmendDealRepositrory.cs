...
{
    public class RPConfirmationAmendDealRepositrory : IRepository<RPTransModel>
    {
        private readonly IUnitOfWork _uow;

        public RPConfirmationAmendDealRepositrory(IUnitOfWork uow)
        {
            _uow = uow;
        }
        ...
        public ResultWithModel Get(RPTransModel model)
        {
            ...
            parameter.ProcedureName = "RP_Release_Message_210002_Confirm_Amend_List_Proc";
