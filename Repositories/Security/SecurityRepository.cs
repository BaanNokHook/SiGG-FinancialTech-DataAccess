...
{
    public class SecurityRepository : IRepository<SecurityModel>
    {
        private readonly IUnitOfWork _uow;

        public SecurityRepository(IUnitOfWork uow)
        {
            _uow = uow;
        }

        public ResultWithModel Add(SecurityModel model)
        {
            BaseParameterModel parameter = new BaseParameterModel();
            parameter.ProcedureName = "GM_Security_810001_Insert_Proc";
            ...
            ResultWithModel rwm = _uow.ExecNonQueryProc(parameter, "InstrumentID", out var outId);
            if (outId != "")
            {
                model.instrument_id = int.Parse(outId);
            }
            rwm.Data = model;
            return rwm;
        }

        public ResultWithModel AddList(List<SecurityModel> models)
        {
            throw new NotImplementedException();
        }

        public ResultWithModel Find(SecurityModel model)
        {
            throw new NotImplementedException();
        }

        public ResultWithModel Get(SecurityModel model)
        {
            BaseParameterModel parameter = new BaseParameterModel();
            parameter.ProcedureName = "GM_Security_810001_List_Proc";
            parameter.Parameters.Add(new Field { Name = "instrument_id", Value = model.instrument_id });
            parameter.Parameters.Add(new Field { Name = "instrument_code", Value = model.instrument_code });
            parameter.Parameters.Add(new Field { Name = "instrument_desc", Value = model.instrument_desc });
            parameter.Parameters.Add(new Field { Name = "instrumenttype", Value = model.instrumenttype });
            ...
            parameter.Parameters.Add(new Field { Name = "redemp_method", Value = model.redemp_method });
        ...
        public ResultWithModel Remove(SecurityModel model)
        {
            BaseParameterModel parameter = new BaseParameterModel();
            parameter.ProcedureName = "GM_Security_810001_Update_Proc";
            parameter.Parameters.Add(new Field { Name = "instrument_id", Value = model.instrument_id });
        ...
        public ResultWithModel Update(SecurityModel model)
        {
            BaseParameterModel parameter = new BaseParameterModel();
            parameter.ProcedureName = "GM_Security_810001_Update_Proc";
            parameter.Parameters.Add(new Field { Name = "instrument_id", Value = model.instrument_id });
        ...
        public ResultWithModel UpdateList(List<SecurityModel> models)
        {
            throw new NotImplementedException();
        }
    }
