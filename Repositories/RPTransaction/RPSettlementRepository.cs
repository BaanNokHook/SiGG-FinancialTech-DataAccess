...
{
    public class RPSettlementRepository : IRPSettlementRepository
    {
        private readonly IUnitOfWork _uow;

        public RPSettlementRepository(IUnitOfWork uow)
        {
            _uow = uow;
        }
        ...
        public ResultWithModel Get(RPTransModel model)
        {
            ...
            parameter.ProcedureName = "RP_Transaction_Settlement_120002_List_Proc";
        ...
        {
            BaseParameterModel parameter = new BaseParameterModel();
            parameter.ProcedureName = "RP_Transaction_Settlement_120002_Coll_Proc";
            parameter.Parameters.Add(new Field { Name = "trans_no", Value = model.trans_no });
            //TODO change ResultModelNames 'GetRPDealSettlementColateralList' to 'GetRPDealSettlementCollateralList'
        ...
        {
            BaseParameterModel parameter = new BaseParameterModel();
            parameter.ProcedureName = "RP_Transaction_Settlement_120002_Update_Proc";
